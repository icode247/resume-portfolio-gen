    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="text-2xl font-bold">
              <span className="text-blue-400">{portfolio?.name?.split(" ")[0]?.toUpperCase() || "DEV"}</span>
              <span className="text-white">.PORTFOLIO</span>
            </div>
            <nav className="hidden md:flex space-x-8">
              <a href="#home" className="text-gray-300 hover:text-blue-400 transition-colors relative group">
                Home
              ...
              <a href="#portfolio" className="text-gray-300 hover:text-blue-400 transition-colors relative group">
                Portfolio
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-400 transition-all group-hover:w-full"></span>
              </a>
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto px-6">
          <div className="mb-8">
            <div className="relative inline-block">
              <img
                src={portfolio?.avatar || "/placeholder.svg?height=180&width=180"}
                alt="Profile"
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-4">
            {portfolio?.bio ? portfolio.bio : "Full Stack Developer & Problem Solver"}
          </p>
          <p className="text-lg text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed">
            {portfolio?.bio || "Passionate about creating innovative web applications and solving complex problems through clean, efficient code."}
          </p>
      ...
      <section id="about" className="py-20 px-6 bg-slate-800/50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h3 className="text-3xl font-bold mb-6 text-blue-400">Full Stack Developer</h3>
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                With {portfolio?.stats?.yearsActive || 'several'} years of experience in software development, I specialize in
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-blue-500/20 to-indigo-600/20 p-6 rounded-lg border border-blue-500/30">
                  <div className="text-3xl font-bold text-blue-400 mb-2">{portfolio?.stats?.repositories || 0}</div>
                  <div className="text-gray-300">Projects Completed</div>
                </div>
                <div className="bg-gradient-to-br from-indigo-500/20 to-purple-600/20 p-6 rounded-lg border border-indigo-500/30">
                  <div className="text-3xl font-bold text-indigo-400 mb-2">{portfolio?.stats?.followers || 0}</div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-8 rounded-xl border border-blue-500/20 hover:border-blue-500/40 transition-all group">
              ...
              <h3 className="text-xl font-bold mb-4 text-center">UI/UX Design</h3>
              <p className="text-gray-400 text-center">
            ...
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-8 rounded-xl border border-blue-500/20 hover:border-blue-500/40 transition-all group">
              ...
              <h3 className="text-xl font-bold mb-4 text-center">Performance Optimization</h3>
              <p className="text-gray-400 text-center">
      ...
      <footer className="py-8 px-6 border-t border-blue-500/20">
        <div className="max-w-6xl mx-auto text-center text-gray-400">
          <p>&copy; 2024 {portfolio?.name || "Portfolio"}. Built with passion for great development.</p>
        </div>
      </footer>
    </div>
  )
