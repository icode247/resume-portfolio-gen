        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="text-2xl font-bold">
              <span className="text-white">{portfolio?.name?.split(" ")[0] || "Portfolio"}</span>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                With {portfolio?.stats?.yearsActive || 'several'} years of experience in digital design and development, I
                specialize in creating immersive experiences that blend aesthetics with functionality.
              </p>
              ...
              <div className="grid grid-cols-3 gap-6 text-center">
                <div>
                  <div className="text-3xl font-bold text-white">{portfolio?.stats?.repositories || 0}</div>
                  <div className="text-gray-400">Projects</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-white">{portfolio?.stats?.followers || 0}</div>
                  <div className="text-gray-400">Followers</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-white">{portfolio?.stats?.yearsActive || 0}</div>
