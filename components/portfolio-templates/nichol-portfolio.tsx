    ...
    <div className="min-h-screen bg-white text-gray-900">
          ...
          <div>
            <h1 className="text-5xl lg:text-7xl font-bold mb-6">
              ...
              <span className="text-green-600">
                {portfolio?.name?.split(" ")[0] || "Developer"}
              </span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              {portfolio?.bio ||
                "Passionate developer creating modern, responsive web applications with clean code and beautiful user interfaces."}
            </p>
            ...
            {portfolio?.skills && portfolio.skills.length > 0
              ...
              : // Fallback generic categories
                [
                  ...
                  {
                    category: "Styling",
                    skills: ["CSS3", "SCSS", "Tailwind", "Bootstrap"],
                  },
                  {
                    category: "Backend",
      ...
      <footer className="py-8 px-6 border-t border-gray-200">
        <div className="max-w-6xl mx-auto text-center text-gray-600">
          <p>
            &copy; 2024 {portfolio?.name || "Portfolio"}. Built with passion and
            code.
          </p>
        </div>
      </footer>
