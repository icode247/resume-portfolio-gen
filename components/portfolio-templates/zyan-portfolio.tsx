    ...
    <div className="min-h-screen bg-white text-gray-900">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold">{portfolio?.name?.charAt(0) || "Z"}</span>
              </div>
              <span className="text-2xl font-bold text-gray-900">{portfolio?.name || "Portfolio"}</span>
            </div>
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <a href="#portfolio" className="text-gray-600 hover:text-blue-600 transition-colors font-medium">
                Portfolio
              </a>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              {portfolio?.bio || "Passionate developer building amazing projects"}
            </p>
          ...
          <div className="relative">
            <div className="relative z-10">
              <img
                src={portfolio?.avatar || "/placeholder.svg?height=500&width=500"}
                alt="Profile"
      ...
      <section id="about" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Passionate Developer</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
                I'm a dedicated developer with {portfolio?.stats?.yearsActive || 'several'} years of experience creating digital solutions. 
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center p-6 bg-blue-50 rounded-xl">
                  <div className="text-3xl font-bold text-blue-600 mb-2">{portfolio?.stats?.repositories || 0}</div>
                  <div className="text-gray-600">Projects</div>
                </div>
                <div className="text-center p-6 bg-purple-50 rounded-xl">
                  <div className="text-3xl font-bold text-purple-600 mb-2">{portfolio?.stats?.followers || 0}</div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all group">
              ...
              <p className="text-gray-600">
                Full-stack web applications built with modern technologies like React, Node.js, and TypeScript
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all group">
              ...
              <p className="text-gray-600">
                Cross-platform mobile applications using React Native and modern development practices
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="portfolio" className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-blue-600 to-purple-600 mx-auto mb-6"></div>
            <p className="text-gray-600 max-w-2xl mx-auto">
              A selection of my recent projects showcasing my skills in web development and design
            </p>
          </div>
      ...
      <footer className="py-8 px-6 border-t border-gray-200">
        <div className="max-w-6xl mx-auto text-center text-gray-600">
          <p>&copy; 2024 {portfolio?.name || "Portfolio"}. Crafted with love and code.</p>
        </div>
      </footer>
    </div>
  )
