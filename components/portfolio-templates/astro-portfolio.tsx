    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 text-white">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-sm">{portfolio?.name?.charAt(0) || "P"}</span>
              </div>
              <span className="text-xl font-bold">{portfolio?.name?.split(" ")[0] || "Portfolio"}</span>
            </div>
      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
          ...
          <p className="text-xl md:text-2xl text-purple-300 mb-4 font-medium">
            {portfolio?.bio ? portfolio.bio : "Full-Stack Developer & Open Source Contributor"}
          </p>

          <p className="text-lg text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed">
            {portfolio?.bio || "Building the future of web development with modern technologies. Passionate about creating scalable applications and contributing to the open-source community."}
          </p>
      ...
      <section id="about" className="py-20 px-6 bg-slate-900/50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h3 className="text-2xl font-bold mb-6 text-purple-400">Developer & Creator</h3>
              <p className="text-gray-300 leading-relaxed mb-6">
                With {portfolio?.stats?.yearsActive || 'several'} years of experience in software development, 
                I've contributed to {portfolio?.stats?.repositories || 'many'} open-source projects and built 
                applications used by developers worldwide.
              </p>
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                <div className="bg-purple-500/10 p-4 rounded-lg border border-purple-500/20">
                  <div className="text-2xl font-bold text-purple-400">{portfolio?.stats?.repositories || 0}</div>
                  <div className="text-gray-400 text-sm">Repositories</div>
                </div>
                <div className="bg-pink-500/10 p-4 rounded-lg border border-pink-500/20">
                  <div className="text-2xl font-bold text-pink-400">{portfolio?.stats?.followers || 0}</div>
                  <div className="text-gray-400 text-sm">Followers</div>
                </div>
                <div className="bg-purple-500/10 p-4 rounded-lg border border-purple-500/20">
                  <div className="text-2xl font-bold text-purple-400">{portfolio?.stats?.yearsActive || 0}</div>
            ...
            <div className="space-y-6">
              <h3 className="text-2xl font-bold mb-8 text-purple-400">Tech Stack</h3>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              A showcase of my recent work, from open-source contributions to full-stack applications
            </p>
          </div>
      ...
      <footer className="py-8 px-6 border-t border-purple-500/20">
        <div className="max-w-6xl mx-auto text-center text-gray-400">
          <p>&copy; 2024 {portfolio?.name || "Portfolio"}. Built with passion for great code.</p>
        </div>
      </footer>
    </div>
  )
