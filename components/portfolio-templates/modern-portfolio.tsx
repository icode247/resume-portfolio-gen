    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-white relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                {portfolio?.bio || "Passionate developer building amazing digital experiences with cutting-edge technology."}
              </p>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                ...
                creating innovative solutions that bridge the gap between design and functionality. My GitHub profile showcases 
                {portfolio?.stats?.repositories || 'many'} repositories with a focus on modern web technologies.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                I believe in the power of clean code, intuitive design, and continuous learning. When I'm not coding,
            ...
            <div className="space-y-6">
              <div className="bg-white/5 p-6 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-blue-400 mb-2">{portfolio?.stats?.repositories || 0}</h3>
                <p className="text-gray-300">Projects Completed</p>
              </div>
              <div className="bg-white/5 p-6 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-cyan-400 mb-2">{portfolio?.stats?.followers || 0}</h3>
                <p className="text-gray-300">GitHub Followers</p>
              </div>
              <div className="bg-white/5 p-6 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-blue-400 mb-2">{portfolio?.stats?.yearsActive || 0}+</h3>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.technologies?.slice(0, 3).map((tech: string, techIndex: number) => (
                        <span key={techIndex} className="bg-blue-500/20 text-blue-300 px-2 py-1 rounded-md text-xs">
                          {tech}
                        </span>
                      ))}
                    </div>
      ...
      <footer className="py-8 px-6 border-t border-white/10">
        <div className="max-w-7xl mx-auto text-center text-gray-400">
          <p>&copy; 2024 {portfolio?.name || "Portfolio"}. Crafted with passion and code.</p>
        </div>
      </footer>
    </div>
  )
