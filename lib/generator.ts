// // AI-powered resume and portfolio generation using Hugging Face
// import { generateProfessionalSummary, generateProjectDescription } from "./huggingface"
// import { sendResumeGeneratedEmail } from "./actions"
// import { createResume, createPortfolio } from "./database"
...
// export async function generateFromGithub(username: string, userId?: string, userEmail?: string) {
//   try {
...
//     const portfolioContent = await generatePortfolioContent(profile, originalRepos)
...
//       resumeId = await createResume(userId, {
//         title: `${profile.name || profile.login} - Resume`,
//         content: resumeContent,
//         githubUsername: username,
//       })

//       portfolioId = await createPortfolio(userId, {
//         title: `${profile.name || profile.login} - Portfolio`,
//         content: portfolioContent,
//         githubUsername: username,
//       })
//     } else {
//       // Generate temporary IDs for non-authenticated users
...
//       try {
//         await sendResumeGeneratedEmail(userEmail, resumeUrl, `${resumeContent.name} - Resume`)
//       } catch (emailError) {
...
// async function generateResumeContent(profile: GitHubProfile, repos: Repository[]) {
...
//     email: profile.email || `${profile.login}@example.com`,
...
// async function generatePortfolioContent(profile: GitHubProfile, repos: Repository[]) {
//   return {
//     name: profile.name || profile.login,
...
//       followers: profile.followers,
//       following: profile.following,
//       yearsActive: Math.max(1, new Date().getFullYear() - new Date(profile.created_at).getFullYear()),
//     },
...
//   const primaryLanguage = Object.entries(topLanguage).sort(([, a], [, b]) => b - a)[0]?.[0] || "Software"
...
//   try {
//     const { getResume } = await import("./database")
//     const resume = await getResume(id)

//     if (resume) {
//       return {
//         resume: resume.content,
//         portfolio: resume.content, // For now, use same content
//       }
//     }
//   } catch (error) {
...
//   // Fallback to mock data for demo with realistic GitHub-like data
//   return {
//     resume: {
//       name: "Alex Johnson",
...
//       summary: "Experienced full-stack developer with 4+ years of experience building scalable web applications. Passionate about open-source contributions and modern JavaScript frameworks.",
...
//           description: "React-based task management application with real-time collaboration and drag-and-drop functionality.",
//           image: "/placeholder.svg?height=200&width=300",
...
//           description: "Microservices API gateway built with Node.js and Express. Handles authentication, rate limiting, and request routing.",
//           image: "/placeholder.svg?height=200&width=300",
//           technologies: ["Node.js", "Express", "Redis", "Docker"],
//           github: "https://github.com/alexjohnson/api-gateway",
